...
img = cv2.imread('entuWoUDpeSk.jpg', 0) #read image as grayscale
...
while(1):
    numpy_horizontal_concat = np.concatenate((cv2.resize(img, (640, 360)), cv2.resize(canny, (640, 360))), axis=1) # to display image side by side
