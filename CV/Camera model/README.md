# References
1. [Best theory + comments for Calibrator tool](http://robot-develop.org/archives/2026)
2. [Theory + python code for calibration](https://waksoft.susu.ru/2020/02/29/kalibrovka-kamery-s-ispolzovaniem-s-opencv/)
3. [Opencv camera calibration guide Python](https://opencv-python-tutroals.readthedocs.io/en/latest/py_tutorials/py_calib3d/py_calibration/py_calibration.html)
